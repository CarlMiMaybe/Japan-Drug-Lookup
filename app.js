...
const DRUGS = [
  ...
  },
  {
    ...
    summary:
      "Usually legal to bring into Japan under the normal MHLW prescription-drug quantity rules.",
    details: [
      "Ramelteon is not listed in the controlled-substances sources used in this app.",
      "Prescription sleep medicines that are not listed as narcotics, psychotropics, or stimulant raw materials are usually handled under the standard MHLW personal-use rules.",
      "If you plan to bring more than 1 month supply, apply for Import Confirmation before travel.",
    ],
    sources: MHLW_SOURCES,
  },
  {
    ...
    summary:
      "Usually legal to bring into Japan under the normal MHLW prescription-drug quantity rules.",
    details: [
      "Suvorexant is not listed in the controlled-substances sources used in this app.",
      "Prescription sleep medicines that are not listed as narcotics, psychotropics, or stimulant raw materials are usually handled under the standard MHLW personal-use rules.",
      "If you plan to bring more than 1 month supply, apply for Import Confirmation before travel.",
    ],
    sources: MHLW_SOURCES,
  },
  {
    ...
    summary:
      "Usually legal to bring into Japan under the normal MHLW prescription-drug quantity rules.",
    details: [
      "Lemborexant is not listed in the controlled-substances sources used in this app.",
      "Prescription sleep medicines that are not listed as narcotics, psychotropics, or stimulant raw materials are usually handled under the standard MHLW personal-use rules.",
      "If you plan to bring more than 1 month supply, apply for Import Confirmation before travel.",
    ],
    sources: MHLW_SOURCES,
  },
  {
    ...
    status: "allowed",
    label: "Usually allowed",
    category: "Sleep or antidepressant medicine",
    summary:
      "Usually legal to bring into Japan under the normal MHLW prescription-drug quantity rules.",
    details: [
      "Trazodone is not listed in the controlled-substances sources used in this app.",
      "It may be used for sleep or depression, but that does not usually change the travel rule under the app's current official sources.",
      "If you plan to bring more than 1 month supply, apply for Import Confirmation before travel.",
    ],
    sources: MHLW_SOURCES,
  },
  {
    ...
    summary:
      "Usually legal to bring into Japan under the normal MHLW prescription-drug quantity rules.",
    details: [
      "Doxepin is not listed in the controlled-substances sources used in this app.",
      "Low-dose sleep products and other doxepin prescription uses are usually handled under the standard MHLW personal-use rules unless another controlled ingredient is involved.",
      "If you plan to bring more than 1 month supply, apply for Import Confirmation before travel.",
    ],
    sources: MHLW_SOURCES,
  },
  ...
  {
    generic: "l-theanine",
    brands: ["Suntheanine", "Nature's Trove L-Theanine", "Sports Research L-Theanine"],
    aliases: ["theanine"],
    status: "allowed",
    label: "Usually allowed",
    category: "Dietary supplement",
    summary:
      "Usually legal to bring into Japan for personal use.",
    details: [
      "L-theanine is not listed in the controlled-substances sources used in this app.",
      "It is commonly sold as a standalone calming or focus supplement, but some products combine it with caffeine or melatonin.",
      "Keep the original label if the product is part of a sleep, stress, or nootropic blend.",
    ],
    sources: [{ label: "MHLW Personal Use Guidance", url: SOURCES.mhlw }],
  },
  {
    generic: "lion's mane",
    brands: ["Host Defense Lion's Mane", "Om Lion's Mane", "FreshCap Lion's Mane"],
    aliases: ["lions mane", "hericium erinaceus"],
    status: "allowed",
    label: "Usually allowed, but check the exact formula",
    category: "Dietary supplement",
    summary:
      "Usually legal to bring into Japan for personal use, but mushroom products vary by formula and extraction style.",
    details: [
      "Lion's mane is not listed in the controlled-substances sources used in this app.",
      "Nootropic and mushroom blends often combine it with cordyceps, reishi, caffeine, or other ingredients.",
      "Use the exact label if the product is sold as a mushroom complex rather than a plain lion's-mane supplement.",
    ],
    sources: [{ label: "MHLW Personal Use Guidance", url: SOURCES.mhlw }],
  },
  {
    generic: "n-acetylcysteine",
    brands: ["NOW NAC", "Jarrow NAC", "Thorne NAC"],
    ...
    summary:
      "Usually legal to bring into Japan for personal use.",
    details: [
      "N-acetylcysteine is not listed in the controlled-substances sources used in this app.",
      "Some wellness products combine NAC with selenium, molybdenum, or other antioxidants, so the exact label can still matter.",
      "Keep the original bottle if you are carrying a concentrated or multi-ingredient formula.",
    ],
    sources: [{ label: "MHLW Personal Use Guidance", url: SOURCES.mhlw }],
  },
  {
    generic: "alpha gpc",
    brands: ["Double Wood Alpha GPC", "NOW Alpha GPC", "Nutricost Alpha GPC"],
    aliases: ["alpha-gpc", "l-alpha glycerylphosphorylcholine"],
    status: "allowed",
    label: "Usually allowed",
    category: "Dietary supplement",
    summary:
      "Usually legal to bring into Japan for personal use.",
    details: [
      "Alpha GPC is not listed in the controlled-substances sources used in this app.",
      "Nootropic products often mix it with caffeine, tyrosine, huperzine, or other focus ingredients.",
      "Keep the original label if the product is sold as part of a larger cognitive-performance stack.",
    ],
    sources: [{ label: "MHLW Personal Use Guidance", url: SOURCES.mhlw }],
  },
  {
    generic: "rhodiola rosea",
    brands: ["Gaia Herbs Rhodiola Rosea", "NOW Rhodiola", "Nature's Way Rhodiola"],
    aliases: ["rhodiola"],
    status: "allowed",
    label: "Usually allowed, but check the exact formula",
    category: "Dietary supplement",
    summary:
      "Usually legal to bring into Japan for personal use, but adaptogen formulas can vary by ingredient list.",
    details: [
      "Rhodiola is not listed in the controlled-substances sources used in this app.",
      "Stress or energy blends often combine it with ashwagandha, caffeine, or other botanicals.",
      "Use the exact ingredient list rather than relying only on the front-of-package claim.",
    ],
    sources: [{ label: "MHLW Personal Use Guidance", url: SOURCES.mhlw }],
  },
  {
    generic: "tongkat ali",
    brands: ["Double Wood Tongkat Ali", "Nootropics Depot Tongkat Ali", "Solaray Tongkat Ali"],
    aliases: ["eurycoma longifolia"],
    status: "allowed",
    label: "Usually allowed, but check the exact formula",
    category: "Dietary supplement",
    summary:
      "Usually legal to bring into Japan for personal use, but hormone-marketing herbal products should be checked by exact label.",
    details: [
      "Tongkat ali is not listed in the controlled-substances sources used in this app.",
      "Products marketed for testosterone, vitality, or performance often combine it with zinc, boron, fadogia, or other ingredients.",
      "Do not confuse a herbal supplement with prescription hormone medicines, which follow different rules.",
    ],
    sources: [{ label: "MHLW Personal Use Guidance", url: SOURCES.mhlw }],
  },
  {
    generic: "l-tyrosine",
    brands: ["NOW L-Tyrosine", "Jarrow L-Tyrosine", "Nutricost L-Tyrosine"],
    aliases: ["tyrosine"],
    status: "allowed",
    label: "Usually allowed",
    category: "Dietary supplement",
    summary:
      "Usually legal to bring into Japan for personal use.",
    details: [
      "L-tyrosine is not listed in the controlled-substances sources used in this app.",
      "Focus and pre-workout products sometimes combine it with caffeine or nootropic blends, so the exact label can still matter.",
      "Single-ingredient amino-acid products are easiest to match and explain.",
    ],
    sources: [{ label: "MHLW Personal Use Guidance", url: SOURCES.mhlw }],
  },
  {
    generic: "glycine",
    brands: ["NOW Glycine", "BulkSupplements Glycine", "Thorne Glycine"],
    aliases: [],
    status: "allowed",
    label: "Usually allowed",
    category: "Dietary supplement",
    summary:
      "Usually legal to bring into Japan for personal use.",
    details: [
      "Glycine is not listed in the controlled-substances sources used in this app.",
      "Sleep and recovery formulas can combine it with magnesium, melatonin, or collagen products.",
      "Plain single-ingredient glycine products are the easiest to match by search.",
    ],
    sources: [{ label: "MHLW Personal Use Guidance", url: SOURCES.mhlw }],
  },
  {
    generic: "bacopa monnieri",
    brands: ["Bacognize", "Himalaya Bacopa", "NOW Bacopa"],
    aliases: ["bacopa", "brahmi"],
    status: "allowed",
    label: "Usually allowed, but check the exact formula",
    category: "Dietary supplement",
    summary:
      "Usually legal to bring into Japan for personal use, but nootropic herbal blends can vary a lot by formula.",
    details: [
      "Bacopa monnieri is not listed in the controlled-substances sources used in this app.",
      "Memory and focus blends often combine it with lion's mane, alpha GPC, theanine, or other ingredients.",
      "Use the exact label if the product is part of a nootropic stack rather than a plain bacopa supplement.",
    ],
    sources: [{ label: "MHLW Personal Use Guidance", url: SOURCES.mhlw }],
  },
  {
    generic: "cordyceps mushroom supplement",
    brands: ["Host Defense Cordyceps", "Om Cordyceps", "FreshCap Cordyceps"],
    aliases: ["cordyceps"],
    status: "allowed",
    label: "Usually allowed, but check the exact formula",
    category: "Dietary supplement",
    summary:
      "Usually legal to bring into Japan for personal use, but mushroom and energy blends can vary by ingredients.",
    details: [
      "Cordyceps is not listed in the controlled-substances sources used in this app.",
      "Performance and mushroom-complex products often combine it with lion's mane, reishi, caffeine, or other ingredients.",
      "Use the exact label if the product is sold as a mushroom blend rather than a plain cordyceps supplement.",
    ],
    sources: [{ label: "MHLW Personal Use Guidance", url: SOURCES.mhlw }],
  },
  {
    generic: "reishi mushroom supplement",
    brands: ["Host Defense Reishi", "Om Reishi", "FreshCap Reishi"],
    aliases: ["reishi", "ganoderma lucidum"],
    status: "allowed",
    label: "Usually allowed, but check the exact formula",
    category: "Dietary supplement",
    summary:
      "Usually legal to bring into Japan for personal use, but mushroom wellness blends can vary by ingredient list.",
    details: [
      "Reishi is not listed in the controlled-substances sources used in this app.",
      "Calm, immune, and sleep blends often combine it with magnesium, melatonin, or other mushroom ingredients.",
      "Use the exact label if the product is sold as part of a broader mushroom complex.",
    ],
    sources: [{ label: "MHLW Personal Use Guidance", url: SOURCES.mhlw }],
  },
  {
    generic: "valerian root",
    brands: ["Nature's Way Valerian", "NOW Valerian Root", "Gaia Herbs Valerian Root"],
    aliases: ["valerian"],
    status: "allowed",
    label: "Usually allowed, but check the exact formula",
    category: "Dietary supplement",
    summary:
      "Usually legal to bring into Japan for personal use, but sleep-herbal blends can vary by ingredients.",
    details: [
      "Valerian root is not listed in the controlled-substances sources used in this app.",
      "Sleep supplements often combine valerian with melatonin, magnesium, theanine, lemon balm, or other botanicals.",
      "Use the exact label if the product is sold as a multi-ingredient sleep blend rather than a plain valerian supplement.",
    ],
    sources: [{ label: "MHLW Personal Use Guidance", url: SOURCES.mhlw }],
  },
  {
    generic: "gaba supplement",
    brands: ["NOW GABA", "Nature's Truth GABA", "Source Naturals GABA Calm"],
    aliases: ["gaba", "gamma aminobutyric acid"],
    status: "allowed",
    label: "Usually allowed, but check the exact formula",
    category: "Dietary supplement",
    summary:
      "Usually legal to bring into Japan for personal use, but calming or sleep blends can vary by ingredient list.",
    details: [
      "GABA supplements are not listed in the controlled-substances sources used in this app.",
      "Many products combine GABA with theanine, magnesium, melatonin, or herbal sleep ingredients.",
      "Keep the original label if the product is part of a broader relaxation or sleep formula.",
    ],
    sources: [{ label: "MHLW Personal Use Guidance", url: SOURCES.mhlw }],
  },
  {
    generic: "magnesium l-threonate",
    brands: ["Magtein", "Life Extension Neuro-Mag", "Jarrow MagMind"],
    aliases: ["magnesium threonate"],
    status: "allowed",
    label: "Usually allowed",
    category: "Dietary supplement",
    summary:
      "Usually legal to bring into Japan for personal use.",
    details: [
      "Magnesium L-threonate is not listed in the controlled-substances sources used in this app.",
      "This is a magnesium supplement variant, but sleep or brain blends can still add other ingredients.",
      "Keep the original label if the product is combined with melatonin, theanine, or other nootropic ingredients.",
    ],
    sources: [{ label: "MHLW Personal Use Guidance", url: SOURCES.mhlw }],
  },
  {
    generic: "zzzquil / unisom sleep products",
    brands: ["ZzzQuil", "Unisom", "Unisom SleepTabs", "Unisom SleepGels"],
    aliases: ["zzzquil", "unisom", "sleep tabs", "sleep gels"],
    status: "allowed",
    label: "Usually allowed, but check the exact version",
    category: "OTC sleep medicine",
    summary:
      "Usually legal to bring into Japan for personal use, but brand-name sleep products can use different active ingredients such as diphenhydramine, doxylamine, or melatonin.",
    details: [
      "ZzzQuil and Unisom products are sold in multiple versions, so the exact active ingredient matters.",
      "Diphenhydramine, doxylamine, and melatonin entries in this app may give a more exact match once you confirm the label.",
      "Keep the original box or bottle because similar-looking sleep products can have different formulas.",
    ],
    sources: [{ label: "MHLW Personal Use Guidance", url: SOURCES.mhlw }],
  },
  {
